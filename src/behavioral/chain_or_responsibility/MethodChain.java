...
public class MethodChain {
    public static void main(String[] args) {
        ...
        // Breaking the chain of responsibility
        System.out.println("Goblin encountered a witch, due to which no bonuses are added");
...
class NoBonusesModifier extends CreatureModifier{
    ...
    public void handle() {
        // nothing
        System.out.println("No bonuses to you!!");
    }
}